...
elseif strcmp(lower(ex(1:5)),'tdoa2');
  if nargin<2, M=2; end  % One sensor makes no sense in this case.
  if M<2
     error('A TDOA2 model needs at least 2 sensors to be able to create time of arrival differences.')
  end
  if slam
